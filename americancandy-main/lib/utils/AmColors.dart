...
const sh_colorPrimary = Color(0xFF004225);
const sh_colorPrimaryDark = Color(0xFF004225);
const sh_colorAccent = Color(0xFF004225);
const sh_gradient_1st = Color(0xFFEFD36F);
const sh_gradient_2nd = Color(0xFF956A24);
...
const appColorPrimary = sh_gradient_2nd;
