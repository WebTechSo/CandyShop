...
import 'package:american_sweets/models/AmPaymentCard.dart';
import 'package:american_sweets/screens/AmAddCardScreen.dart';
...
class AmPaymentsScreen extends StatefulWidget {
  static String tag = '/AmPaymentsScreen';

  @override
  AmPaymentsScreenState createState() => AmPaymentsScreenState();
}

class AmPaymentsScreenState extends State<AmPaymentsScreen> {
  List<AmPaymentCard> mPaymentCards = [];

  @override
  void initState() {
    super.initState();
    mPaymentCards.add(AmPaymentCard());
    mPaymentCards.add(AmPaymentCard());
    mPaymentCards.add(AmPaymentCard());
    mPaymentCards.add(AmPaymentCard());
    mPaymentCards.add(AmPaymentCard());
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      AmAddCardScreen().launch(context);
                    },
                  )
                ],
              ),
            ),
            AmPaymentCards(mPaymentCards),
            Padding(
              padding: EdgeInsets.all(spacing_standard_new),
              child: Column(
                children: <Widget>[
...
class AmPaymentCards extends StatelessWidget {
  List<AmPaymentCard> mSliderList;

  AmPaymentCards(this.mSliderList);
