...
class AmAddCardScreen extends StatefulWidget {
  static String tag = '/AmAddCardScreen';
  AmPaymentCard? paymentCard;

  AmAddCardScreen({this.paymentCard});

  @override
  AmAddCardScreenState createState() => AmAddCardScreenState();
}

class AmAddCardScreenState extends State<AmAddCardScreen> {
