...
class AmEmailScreen extends StatefulWidget {
  static String tag = '/AmEmailScreen';

  @override
  AmEmailScreenState createState() => AmEmailScreenState();
}

class AmEmailScreenState extends State<AmEmailScreen> {
