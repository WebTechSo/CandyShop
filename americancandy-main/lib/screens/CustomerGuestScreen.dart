...
class CustomerGuestScreen extends StatefulWidget {
  const CustomerGuestScreen({Key? key}) : super(key: key);
  @override
  State<CustomerGuestScreen> createState() => _CustomerGuestScreenState();
}

class _CustomerGuestScreenState extends State<CustomerGuestScreen> {
  int _currentTab = 4;
  String _sortLabel = 'Sort by Total Orders';
  final TextEditingController _searchCtrl = TextEditingController();

  final List<_Customer> _customers = [
    _Customer(name: 'Alice Johnson', email: 'alice.j@example.com', type: _CustType.guest, totalOrders: 12),
    _Customer(name: 'Charlie Brown', email: 'charlie.b@email.com', type: _CustType.guest, totalOrders: 5),
  ];
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        10.height,
                        Row(children: [
                          _Badge(label: 'Guest', bgColor: const Color(0x332F8F46), textColor: const Color(0xFF2F8F46)),
                          const Spacer(),
...
class _Badge extends StatelessWidget {
  ...
  const _Badge({Key? key, required this.label, required this.bgColor, required this.textColor}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
